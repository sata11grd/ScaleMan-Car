...
public class ScreenshotTools
{
    ...
    public static void CaptureScreenshot()
    {
        ...
        string screenshot_directroy;
        screenshot_directroy = "Screenshot";
        string directory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory),screenshot_directroy, productName);
