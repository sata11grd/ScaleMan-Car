...
{
    public class ComManager_green : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            SetSliderValueSmoothly(delay: 11.5f, value: 1.0f, duration: 0.5f);

            // 15秒後に0.5秒間かけて0.2までスライダーを移動します。
            SetSliderValueSmoothly(delay: 13.5f, value: 0.01f, duration: 0.5f);
