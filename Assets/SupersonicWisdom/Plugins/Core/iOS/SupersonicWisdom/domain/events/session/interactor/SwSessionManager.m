...
- (void)startSession {
    ...
    NSDictionary *event = [SwUtils createEvent:SESSION_EVENT_NAME sessionId:currentSessionId conversionData:[eventConversionDataManager conversionData] metdadata:[[eventMetadataManager get] get] customs:[SwUtils toJsonString:customs] extra:@"{}"];
