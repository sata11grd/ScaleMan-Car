...
+ (NSDictionary *)createEvent:(NSString *)eventName sessionId:(NSString *)sessionId conversionData:(NSString *)conversionData metdadata:(NSString *)metadata customs:(NSString *)customs extra:(NSString *)extra{
    ...
    NSMutableDictionary *mutDict = [@{
        ...
        KEY_SESSION: [SwUtils replaceNil:sessionId],
