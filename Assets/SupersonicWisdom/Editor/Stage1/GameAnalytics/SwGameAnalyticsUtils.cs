...
namespace SupersonicWisdomSDK.Editor
{
    internal static class SwGameAnalyticsUtils
    {
        ...
        internal static void VerifyMandatoryFlags ()
        {
            ...
            {
                var shouldUpdate = SwEditorAlerts.AlertWarning(SwEditorConstants.UI.VerifyGASettings, SwEditorConstants.UI.ButtonTitle.SetToTrueAndSave, SwEditorConstants.UI.ButtonTitle.Cancel);
