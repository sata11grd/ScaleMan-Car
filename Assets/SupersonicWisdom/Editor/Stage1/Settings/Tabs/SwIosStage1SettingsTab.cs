...
{
    internal class SwIosStage1SettingsTab : SwIosCoreSettingsTab
    {
        #region --- Members ---
        ...
        public SwIosStage1SettingsTab(SerializedObject soSettings) : base(soSettings)
        { }
        ...
        protected internal override void DrawContent ()
        {
            ...
            GUILayout.Label(IosAppIdLabel, GUILayout.Width(LabelWidth));
        ...
        private void DrawGameAnalytics ()
        {
            ...
            GUILayout.Space(SpaceBetweenFields);
            GUILayout.BeginHorizontal();
            var (iosGameAnalyticsGameKey, iosGameAnalyticsSecretKey) = SwStage1EditorUtils.GetGameAnalyticsKeys(RuntimePlatform.IPhonePlayer);
            GUILayout.Label(GameAnalyticsIosGameKeyLabel, GUILayout.Width(LabelWidth));
            ...
            GUILayout.Space(SpaceBetweenFields);
            GUILayout.BeginHorizontal();
            GUILayout.Label(GameAnalyticsIosSecretKeyLabel, GUILayout.Width(LabelWidth));
            ...
            {
                SwStage1EditorUtils.SetGameAnalyticsKeys(RuntimePlatform.IPhonePlayer, Settings.iosGameAnalyticsGameKey, Settings.iosGameAnalyticsSecretKey);
            }
        }
