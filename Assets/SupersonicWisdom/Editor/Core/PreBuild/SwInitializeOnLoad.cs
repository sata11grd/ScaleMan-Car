...
namespace SupersonicWisdomSDK.Editor
{
    ...
    internal static class SwInitializeOnLoad
    {
        ...
        private const string IosChinaPopupMessage = "Since iOS CN is enabled in your wisdom \nsettings, this build will be created with iOS CN \nsettings. Are you sure?";

        private const string IosChinaPopupTitle = "iOS China Build";
        ...
        private static void OnBuild(BuildPlayerOptions buildPlayerOptions)
        {
            ...
            {
                if (!EditorUtility.DisplayDialog(IosChinaPopupTitle, IosChinaPopupMessage, "Ok", "Cancel"))
                {
                    return;
                }
            }
        ...
        private static bool CheckPlatformSettings(BuildTarget target)
        {
            ...
            var param = validator.CheckMissingParams();
