...
namespace SupersonicWisdomSDK.Editor
{
    internal abstract class SwSettingsValidator
    {
        ...
        {
            SwEditorAlerts.AlertWarning(SwEditorConstants.UI.DuplicateProduct.Format(GetIapDuplicationDetails(param)), SwEditorConstants.UI.ButtonTitle.Ok);
        }

        public void HandleMissingParam(MissingParam param)
        {
            SwEditorAlerts.AlertWarning(SwEditorConstants.UI.ParamIsMissing.Format(GetDetails(param)), SwEditorConstants.UI.ButtonTitle.Ok);
        }
