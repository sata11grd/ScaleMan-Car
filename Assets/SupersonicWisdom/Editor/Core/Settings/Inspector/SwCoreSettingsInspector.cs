...
namespace SupersonicWisdomSDK.Editor
{
    internal class SwCoreSettingsInspector : UnityEditor.Editor, ISwRepaintDelegate
    {
        ...
        protected const int LabelWidth = SwCoreSettingsTab.LabelWidth;
        ...
        private SwCoreSettingsTab[] _tabs = { };
        ...
        {
            get { return SwCoreSettingsTab.SpaceBetweenFields; }
        }
        ...
        private void DrawSupersonicTitle ()
        {
            ...
            GUILayout.Label(SwGameObjectLogo.Logo, GUILayout.Width(32), GUILayout.Height(32));
            GUILayout.BeginVertical();
            GUILayout.Space(8);
            GUILayout.BeginHorizontal();
