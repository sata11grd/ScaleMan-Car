...
namespace SupersonicWisdomSDK
{
    internal class SwNativeAndroidBridge : SwNativeBridge
    {
        ...
        private const string EventMetadataDtoClass = "com.supersonic.wisdom.library.domain.events.dto.EventMetadataDto";
        private const string ExtraEventDetailsDtoClass = "com.supersonic.wisdom.library.domain.events.dto.ExtraEventDetailsDto";
        ...
        private const string WisdomConfigurationClass = "com.supersonic.wisdom.library.api.dto.WisdomConfigurationDto";
        private const string WisdomSDKClass = "com.supersonic.wisdom.library.api.WisdomSDK";
