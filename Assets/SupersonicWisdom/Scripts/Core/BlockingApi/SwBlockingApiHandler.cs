...
namespace SupersonicWisdomSDK
{
    ...
    internal class SwBlockingApiHandler
    {
        ...
        public IEnumerator NotifyLevelRevived(long level, string levelName = null)
        {
            ...
            _userData.ModifyUserStateSync(mutableUserState => { mutableUserState.levelRevives++; });
        ...
        public void NotifyRewardedVideoOpportunityMissed(Action action)
        {
            SwInfra.CoroutineService.StartCoroutineWithCallback(NotifyRewardedVideoOpportunityMissed, action);
        }

        public IEnumerator NotifyRewardedVideoOpportunityMissed ()
        {
