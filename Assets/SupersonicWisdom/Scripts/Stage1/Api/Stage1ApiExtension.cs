...
namespace SupersonicWisdomSDK
{
    public static class Stage1ApiExtension
    {
        ...
        {
            self.RunWithContainerOrThrow(() => Container.BlockingApiHandler.NotifyLevelCompleted(level, action, levelName), "NotifyLevelCompleted");
        }
        ...
        {
            self.RunWithContainerOrThrow(() => Container.BlockingApiHandler.NotifyLevelFailed(level, action, levelName), "NotifyLevelFailed");
        }
        ...
        {
            self.RunWithContainerOrThrow(() => Container.BlockingApiHandler.NotifyLevelRevived(level, action), "NotifyLevelRevived");
        }
        ...
        {
            self.RunWithContainerOrThrow(() => Container.BlockingApiHandler.NotifyLevelSkipped(level, action), "NotifyLevelSkipped");
        }
        ...
        {
            self.RunWithContainerOrThrow(() => Container.BlockingApiHandler.NotifyLevelStarted(level, action), "NotifyLevelStarted");
        }
