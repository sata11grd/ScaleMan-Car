...
namespace SupersonicWisdomSDK
{
    internal class SwStage1Container : SwCoreContainer
    {
        ...
        public new static ISwContainer GetInstance(Dictionary<string, object> initParamsDictionary)
        {
            ...
            var wisdomNativeAdapter = new SwStage1NativeAdapter(wisdomNativeApi, settingsManager.Settings, userData, sessionListener);
            ...
            var tracker = new SwCoreTracker(wisdomNativeAdapter, userData, webRequestClient, timerManager);
        ...
        private IEnumerator RegisterAppForAdNetwork ()
        {
            yield return new WaitForSeconds(1);
            SwSKAdNetworkAdapter.RegisterAppForAdNetwork();
        }
        ...
        private void OnFacebookInitComplete ()
        {
            ...
            {
                SwInfra.CoroutineService.StartCoroutine(RegisterAppForAdNetwork());
            }
        }
