...
public class TatoonEditor_CutOut : ShaderGUI
{
    ...
    /*void Outline(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        MaterialProperty OutlineNoiseTexture = FindProperty("_OutlineNoiseTexture", properties);
        ...
        if(UseOutline.floatValue == 1 && UseOutlineFire.floatValue == 1)
        {
            ...
            EditorGUILayout.BeginHorizontal();
            {
                ...
                materialEditor.TexturePropertySingleLine(FxStyles.textureLabel, OutlineNoiseTexture);
