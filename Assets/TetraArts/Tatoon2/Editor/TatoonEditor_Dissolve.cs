...
public class TatoonEditor_Dissolve : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        Dissolve(materialEditor, properties);
    ...
    void Diffuse(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        //MaterialProperty CutOut = ShaderGUI.FindProperty("_CutOut", properties);
        ...
        //materialEditor.ShaderProperty(CutOut, CutOut.displayName);
    ...
    void Dissolve(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        MaterialProperty NoiseSize = FindProperty("_NoiseSize", properties);
        MaterialProperty NoiseStrength = FindProperty("_NoiseStrength", properties);
        MaterialProperty EdgeSize = FindProperty("_EdgeSize", properties);
        MaterialProperty Dissolve = FindProperty("_Dissolve", properties);
        MaterialProperty AxeX = FindProperty("_AxeX", properties);
        MaterialProperty AxeY = FindProperty("_AxeY", properties);
        MaterialProperty AxeZ = FindProperty("_AxeZ", properties);
        MaterialProperty Invert = FindProperty("_Invert", properties);

        GUILayout.Label("DISSOLVE", EditorStyles.boldLabel);

        materialEditor.ShaderProperty(UseDissolve, UseDissolve.displayName);
        if (UseDissolve.floatValue == 1)
        {
            materialEditor.ShaderProperty(EdgeColor, EdgeColor.displayName);
            materialEditor.ShaderProperty(NoiseSize, NoiseSize.displayName);
            materialEditor.ShaderProperty(NoiseStrength, NoiseStrength.displayName);
            materialEditor.ShaderProperty(EdgeSize, EdgeSize.displayName);
            materialEditor.ShaderProperty(Dissolve, Dissolve.displayName);
            materialEditor.ShaderProperty(AxeX, AxeX.displayName);
            materialEditor.ShaderProperty(AxeY, AxeY.displayName);
            materialEditor.ShaderProperty(AxeZ, AxeZ.displayName);
    ...
    void Outline(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        if (UseOutline.floatValue == 1)
        {
            ...
            if (OutlineNoise.floatValue == 1 && OutlineNoise.floatValue == 1)
            {
