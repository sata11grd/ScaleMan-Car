...
public class SessionManager implements ISessionManager, ISessionListener {
    ...
    private void startSession() {
        ...
        try {
            ...
            JSONObject event = SwUtils.createEvent(SESSION_EVENT_NAME, mCurrentSessionId, mConversionDataManager.getConversionData(), mEventMetadataManager.get(), customsJson.toString(), "");
