...
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_INTERNAL_ERROR;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_INTERNAL_IO_ERROR;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_INTERNAL_MALFORMED_URL;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_INTERNAL_NO_INTERNET;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_INTERNAL_PROTOCOL_ERROR;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_INTERNAL_UNSUPPORTED_ENCODING;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_NO_INTERNET_CONNECTION_MSG;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_READ_BUFFER_SIZE;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_REQUEST_ENCODING;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_REQUEST_HEADER_HOST;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_REQUEST_METHOD_GET;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_REQUEST_METHOD_POST;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_RESPONSE_CODE_BAD_REQUEST;
import static com.supersonic.wisdom.library.data.framework.network.core.WisdomNetwork.WISDOM_RESPONSE_CODE_OK;
